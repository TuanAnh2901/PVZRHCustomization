...
namespace SuperCornUmbrella.BepInEx
{
    ...
    [BepInPlugin("inf75.supercornumbrella", "SuperCornUmbrella", "1.0")]
    public class Core : BasePlugin//966
    {
...
//退化戰神：可能要警惕一下看起來很可疑的店家或是訊息，不然會重覆捲心瓜的開頭慘案，但退化戰神是之後才聽的警訊...