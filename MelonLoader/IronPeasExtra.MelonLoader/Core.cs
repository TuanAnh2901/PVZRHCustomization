...
namespace IronPeasExtra.MelonLoader
{
    ...
    public class Core : MelonMod
    {
        public override void OnInitializeMelon()
        {
            ...
            //CustomCore.RegisterCustomUseItemOnPlantEvent((PlantType)163, BucketType.SuperMachine, (PlantType)300);
            //CustomCore.RegisterCustomUseItemOnPlantEvent((PlantType)163, BucketType.Bucket, SuperIronGatling.Shooter);
