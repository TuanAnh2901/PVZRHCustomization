...
namespace SuperGarlicFume.MelonLoader
{
    public class Core : MelonMod
    {
        public override void OnInitializeMelon()
        {
            ...
            SuperGarlicFume.Buff1 = CustomCore.RegisterCustomBuff("The room is filled with garlic aroma: Ultimate Garlic Big Puffshroom cancels the zombie garlic value limit when attacking.", BuffType.AdvancedBuff, () => Lawnf.TravelUltimate(4) && Lawnf.TravelUltimate(5) && Board.Instance.ObjectExist<SuperGarlicFume>(), 5400, "#DA64FF", (PlantType)165);
            SuperGarlicFume.Buff2 = CustomCore.RegisterCustomBuff("Super Toxic: The Ultimate Garlic Spray Mushroom can deal extra damage to zombies equal to their total health multiplied by the garlic value percentage.", BuffType.AdvancedBuff, () => Lawnf.TravelUltimate(4) && Lawnf.TravelUltimate(5) && Lawnf.TravelAdvanced(SuperGarlicFume.Buff1) && Board.Instance.ObjectExist<SuperGarlicFume>(), 17900, "red", (PlantType)165);
            SuperGarlicFume.Buff3 = CustomCore.RegisterCustomBuff("The Ice Garlic Day: The Ultimate Garlic Spitter Mushroom can increase the garlic value of zombies to the power of e (the total number of ultimate shooters in the row + 1) when zombies are frozen, dealing additional damage to the zombie's body equal to (garlic value × (the total number of ultimate shooters in the row + 1) cubed).", BuffType.AdvancedBuff, () => Lawnf.TravelUltimate(4) && Lawnf.TravelUltimate(5) && Lawnf.TravelAdvanced(SuperGarlicFume.Buff2) && Board.Instance.ObjectExist<SuperGarlicFume>(), 17900, "red", (PlantType)165);
