...
namespace SuperGarlicFume.MelonLoader
{
    public class Core : MelonMod
    {
        public override void OnInitializeMelon()
        {
            ...
            SuperGarlicFume.Buff1 = CustomCore.RegisterCustomBuff("满屋蒜香：究极蒜大喷菇攻击时取消僵尸蒜值上限", BuffType.AdvancedBuff, () => Lawnf.TravelUltimate(4) && Lawnf.TravelUltimate(5) && Board.Instance.ObjectExist<SuperGarlicFume>(), 5400, "#DA64FF", (PlantType)965);
            SuperGarlicFume.Buff2 = CustomCore.RegisterCustomBuff("超剧毒：究极蒜大喷菇可以对僵尸额外造成总血量×蒜值%的伤害", BuffType.AdvancedBuff, () => Lawnf.TravelUltimate(4) && Lawnf.TravelUltimate(5) && Lawnf.TravelAdvanced(SuperGarlicFume.Buff1) && Board.Instance.ObjectExist<SuperGarlicFume>(), 17900, "red", (PlantType)965);
            SuperGarlicFume.Buff3 = CustomCore.RegisterCustomBuff("冰蒜天：究极蒜大喷菇可以在僵尸被冻结时使僵尸蒜值增加e的(本行究极投手总数+1)次方，对僵尸本体额外造成(蒜值×(本行究极投手总数+1)的三次方)伤害", BuffType.AdvancedBuff, () => Lawnf.TravelUltimate(4) && Lawnf.TravelUltimate(5) && Lawnf.TravelAdvanced(SuperGarlicFume.Buff2) && Board.Instance.ObjectExist<SuperGarlicFume>(), 17900, "red", (PlantType)965);
