...
namespace IceDoomScaredyShroom.MelonLoader
{
    public class Core : MelonMod//304
    {
        public override void OnInitializeMelon()
        {
            ...
            CustomCore.RegisterCustomPlant<IceScaredyShroom, IceDoomScaredyShroom>(304, ab.GetAsset<GameObject>("IceDoomScaredyShroomPrefab"),
                ab.GetAsset<GameObject>("IceDoomScaredyShroomPreview"), [(9, 1040), (1040, 9), (1038, 11), (11, 1038), (1042, 10), (10, 1042)], 0.1f, 0, 200, 30000, 7.5f, 300);
    ...
    public class IceDoomScaredyShroom : MonoBehaviour
    {
        ...
        public void AnimDoom()
        {
            ...
            plant.thePlantHealth = (int)(plant.thePlantHealth - 100);
            
            while (shoot - 10 == 0)
            {
                shoot = 1;
                plant.attackDamage += 100;
                plant.thePlantMaxHealth = (int)(plant.thePlantMaxHealth + plant.attackDamage);
                MelonLogger.Msg($"当前攻击力：{plant.attackDamage}");
                MelonLogger.Msg($"Shoot：{shoot}");
            }
            if (plant.attackDamage >= int.MaxValue - 10) {
                plant.attackDamage = int.MaxValue - 10000;
            }
        ...
        public void UpgradeShoot()
        {
            ...
            plant.attributeCountdown = 0.001f;
            plant.UpdateText();
        }
        ...
        public void SuperAnimShoot()
        {
            ...
            CreateBullet.Instance.SetBullet(t.position.x + 0.1f, t.position.y, plant.thePlantRow, BulletType.Bullet_springMelon, 0).Damage = plant.attackDamage;
